...
public class LivePersonalTrainingPage {
	...
	// 返回主界面back to main interface botton
	...
	private class MyActionListener implements ActionListener {
		...
		public void actionPerformed(ActionEvent e) {
			...
			String fileName = "./file/trainer.txt";//要读取的文件名
			ArrayList<String> trainerInfoList = new ArrayList<String>();//存储要显示的教练信息
            ...
            if (button.equals(searchBtn)) {
				...
				else{//显示基础信息，如果没有选择就会提示框 并且显示初始界面
